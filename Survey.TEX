...
% --- TABLA COMPARATIVA FLOTANTE ---
\begin{table*}[tbp]
\centering
\caption{Comparativa de Literatura Relevante (Ejes A, B y C)}
\label{tab:comparativa}
\scriptsize
\begin{tabular}{p{2cm} c p{2cm} p{2.5cm} p{2.5cm} p{3.5cm} p{3cm}}
\toprule
...
\midrule
Xu \& Dang \cite{Paper18} & 2025 & MADDPG & Gridworld 2D acotado & Tasa de captura & 99.9 \% de éxito desarrollando 21 patrones tácticos. & Excluye recompensas continuas por distancia. \\
\addlinespace
...
\addlinespace
Barton et al. \cite{Paper17} & 2018 & MADDPG & Entorno continuo 2D & Recompensa media & Mejora sustancial frente a enfoques sin aprendizaje. & Alto desempeño no garantiza coordinación biológica. \\
\bottomrule
\end{tabular}
\end{table*}
